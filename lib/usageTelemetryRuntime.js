...
import { FEATURE_PRICING, getLowestRevenuePerCreditUsd } from './pricingRuntime.js';
...
function buildTelemetryMetadata(event) {
...
export async function logUsageTelemetry(event) {
