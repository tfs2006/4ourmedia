...
export async function generatePromoAnalysis(ai, url, platform = 'instagram') {
...
export async function generatePromoAsset(ai, url, platform = 'instagram') {
  const analysis = await generatePromoAnalysis(ai, url, platform);
